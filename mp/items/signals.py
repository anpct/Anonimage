...
def scale_features(features):
    with open('C:\\Users\\anthi\\Documents\\GitHub\\mp\\mp\\frontend\\static\\frontend\\ml\\normalize.pickle', 'rb') as handle:
...
def calculate_image_quality_score(brisque_features):
    model = svmutil.svm_load_model('C:\\Users\\anthi\\Documents\\GitHub\\mp\\mp\\frontend\\static\\frontend\\ml\\brisque_svm.txt')
